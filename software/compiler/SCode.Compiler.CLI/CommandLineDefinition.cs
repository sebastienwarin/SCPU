...
namespace SCode.Compiler.CLI
{
    ...
    /// for the S-Code compiler. 
    /// </summary>
    public static class CommandLineDefinition
    {
        /// <summary>
        /// Required argument representing the input S-Code file to compile.
        /// </summary>
        ...
        /// <summary>
        /// If set, prints the output to the console.
        /// </summary>
        ...
        {
            Description = "POST the final output to the specified URL (e.g. http://slink.local/upload).",
        ...
        public static RootCommand BuildRootCommand()
        {
            ...
            return new RootCommand("S-Code Compiler")
            {
    ...
    /// <summary>
    /// Represents the strongly-typed, parsed command-line options for the compiler.
    /// </summary>
